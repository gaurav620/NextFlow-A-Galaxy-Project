...
export default function ImageGenNode({ id, data }: any) {
  ...
  return (
    <div className={`relative rounded-2xl w-[340px] transition-all group ${dark ? 'bg-[#1A1A1A] border border-white/[0.08]' : 'bg-white border border-black/[0.08]'} shadow-xl hover:shadow-2xl ${data.isExecuting ? 'node-executing' : ''}`}>
